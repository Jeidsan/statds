...
::: {.enunciado}
Considere o conjunto de dados disponível no arquivo `esforco.xls` [@Braga1996].
...
```
#### Gráfico QQ para o consumo de oxigênio
...
qq_esforco %>%
  ...
  ggplot(aes(qq_rep, qq_w, slope = 1, intercept = 0)) +
    ...
    labs(
      title = bquote(bold("Figura 4.12:")~"Quantis do consumo de oxigênio em repouso"~italic("vs.")~"pico do exercício"),
...
qq_esforco %>%
  ...
  ggplot(aes(qq_media, qq_diff)) +
    ...
    facet_wrap(~etiologia) +
    labs(
      title = bquote(bold("Figura 4.13:")~"Média do consumo de oxigênio"~italic("vs.")~"diferença entre os estágios"),
