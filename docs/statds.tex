...
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}
      \AttributeTok{title =} \StringTok{"Figura 3.65: Distribuição da variável \textasciigrave{}PCRa\textasciigrave{} entre pacientes"}\NormalTok{,}
      \AttributeTok{y =} \StringTok{"Quantidade"}
\NormalTok{    ) }\SpecialCharTok{+}
\NormalTok{    tema}
\end{Highlighting}
...
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}
      \AttributeTok{title =} \StringTok{"Figura 3.66: Número de gestações entre mulheres com e sem endometriose"}\NormalTok{,}
