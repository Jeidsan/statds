...
Analise a variável Temperatura do arquivo \texttt{poluicao.xls}.
...
Construa um gráfico ramo-e-folhas e um boxplot para os dados de precipitação atmosférica de Fortaleza disponíveis no arquivo precipitacao. manchas solares disponiveis no arquivo \texttt{manchas.xls}.
