...
Considere o conjunto de dados disponivel no arquivo \texttt{regioes.xls}. Avalie a relação entre variáveis \texttt{Região} e \texttt{Densidade\ populacional}.
...
\hypertarget{exr4-25}{%
\subsection*{Exercício 4.28}\label{exr4-25}}
