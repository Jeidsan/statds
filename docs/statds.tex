...
O arquivo \texttt{rehabcardio.xls} contém informações sobre um estudo de reabilitação de pacientes cardiacos. Elabore um relatório indicando possíveis inconsistências na matriz de dados e faça uma análise descritiva das variáveis \texttt{Peso}, \texttt{Altura}, \texttt{Coltot}, \texttt{HDL}, \texttt{LDL}, \texttt{Lesces}, \texttt{Diabete} e \texttt{RA}. Com essa finalidade,
